...
- Явное число деревьев HPO ограничивает ES-fit; финальные refit используют медиану фактических DEV rounds.
...
- Формат candidate/stage cache — 2; несовместимые записи пересчитываются. Формат HPO checkpoint — 2.
