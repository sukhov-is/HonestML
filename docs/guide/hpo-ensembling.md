...
в отчёте. DEV/full refit и участники ансамбля сохраняют параметры выбранной
фабрики, включая бюджет деревьев из default, явной конфигурации или HPO.
Медиана остановок CV остаётся диагностикой и не меняет этот бюджет.
Фактическое число построенных деревьев может быть меньше потолка, например
при отсутствии допустимых разбиений у backend. Внешний holdout не участвует
в выборе бюджета refit.
