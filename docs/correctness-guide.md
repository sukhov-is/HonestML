...
- **Early stopping внутри HPO.** При доступном ES-разбиении внутренний CV
  ...
  сохраняет параметры выбранной фабрики, включая бюджет деревьев. Медиана
  остановок CV используется для диагностики и прогноза стоимости; внешний
  holdout не выбирает число деревьев.
